    ...
    <div className="flex-1 overflow-y-auto p-6 md:p-8 custom-scroll">
      ...
      <div className="bg-surface rounded-[var(--radius-lg)] border border-border shadow-[var(--shadow-card)] p-5 max-w-[520px]">
        ...
        {step === "info" && (
          <div className="flex flex-col gap-4">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 px-4 py-[7px] rounded-[var(--radius-sm)] bg-accent text-white text-[15px] font-medium hover:brightness-110 transition-all duration-[120ms]"
            >
              Next: Select Assets
            </button>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="inline-flex items-center justify-center gap-1.5 px-4 py-[7px] rounded-[var(--radius-sm)] border border-border bg-surface text-text-primary text-[15px] font-medium hover:bg-border transition-all duration-[120ms]"
              >
                Back
              </button>
              <button
        ...
        {step === "review" && (
          <div className="flex flex-col gap-4">
            <div>
              <p className="text-[11px] font-medium text-[#D4BDAB] uppercase tracking-wide mb-1">
                Client
              </p>
            ...
            <div>
              ...
              {selectedAssets.length === 0 ? (
                <p className="text-[15px] text-text-3">No assets selected</p>
              ) : (
                <ul className="flex flex-col gap-0.5">
                  {selectedAssets.map((a) => (
                    <li key={`${a.category}-${a.name}`} className="text-[15px] text-text-primary">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={saving}
                className="inline-flex items-center justify-center gap-1.5 px-4 py-[7px] rounded-[var(--radius-sm)] bg-accent text-white text-[15px] font-medium hover:brightness-110 transition-all duration-[120ms] disabled:opacity-50"
              >
