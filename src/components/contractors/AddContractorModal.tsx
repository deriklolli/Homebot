          ...
          <label className="flex flex-col gap-1.5">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 px-3 py-[7px] text-[15px] bg-surface border border-border rounded-[var(--radius-sm)] text-text-primary placeholder:text-text-4 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent/30 transition-all duration-[120ms]"
          ...
          <div className="flex items-center gap-3 pt-2 border-t border-border">
            {isEditing && onDelete && (
              <button
                type="button"
                onClick={onDelete}
                className="inline-flex items-center gap-1.5 px-3.5 py-[7px] rounded-[var(--radius-sm)] border border-red/30 bg-surface text-red text-[15px] font-medium hover:bg-red-light transition-all duration-[120ms]"
              >
