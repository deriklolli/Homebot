    ...
    <div className="flex flex-col sm:flex-row gap-3 mb-4">
      ...
      <div className="relative inline-flex items-center">
        <select
          ...
          className="appearance-none bg-surface border border-border rounded-[var(--radius-sm)] py-[7px] pl-3 pr-8 text-[15px] font-medium text-text-primary cursor-pointer hover:border-border-strong focus:border-accent focus:ring-1 focus:ring-accent/30 transition-all duration-[120ms]"
