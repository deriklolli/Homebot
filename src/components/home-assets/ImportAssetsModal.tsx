      ...
      <div className="bg-surface rounded-[var(--radius-lg)] border border-border shadow-[var(--shadow-hover)] w-full max-w-2xl mx-4 max-h-[90vh] flex flex-col">
        ...
        {step === "select" && (
          <div className="p-5 flex flex-col gap-4">
            ...
            {fileError && (
              <p className="text-[15px] text-red font-medium">{fileError}</p>
            )}

            <button
              type="button"
              onClick={downloadTemplate}
              className="text-[15px] text-accent hover:underline self-start"
        ...
        {step === "results" && (
          <div className="p-8 flex flex-col items-center gap-4">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-[7px] rounded-[var(--radius-sm)] bg-accent text-white text-[15px] font-medium hover:brightness-110 transition-all duration-[120ms] mt-2"
            >
              Done
            </button>
          </div>
