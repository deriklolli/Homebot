                  ...
                  >
                    ...
                    {item.thumbnailUrl ? (
                      <img
                        ...
                        alt={item.name}
                        className="w-10 h-10 rounded-[var(--radius-sm)] object-cover shrink-0 bg-border"
                      />
                    ) : (
                      <div className="w-10 h-10 rounded-[var(--radius-sm)] bg-border/50 shrink-0 flex items-center justify-center">
                        <PackageIcon width={16} height={16} className="text-text-4" />
                      </div>
                    )}
