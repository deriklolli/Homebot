...
export default function CurrencyInput({
  ...
  return (
    ...
    >
      <span className="pl-3 text-[15px] text-text-3 select-none">$</span>
      <input
        ref={inputRef}
        type="text"
        inputMode="numeric"
        ...
        className="flex-1 px-1.5 py-[7px] text-[15px] bg-transparent text-text-primary placeholder:text-text-4 focus:outline-none"
