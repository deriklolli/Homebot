  ...
  return (
    <>
      <button
        ...
        className={cn(
          "flex items-center justify-between gap-2 w-full px-3 py-[7px] text-[15px] bg-surface border border-border rounded-[var(--radius-sm)] transition-all duration-[120ms] text-left",
          open
              ...
              <>
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    ...
                    className="text-[15px] font-semibold text-text-primary hover:text-accent transition-colors duration-[120ms]"
                  >
